# 0x10: C - printf
For this project we wrote own `printf` function. It is the first group project for [Holberton School](https://www.mainschool.com/ "Holberton School"). Our version of `printf` currently handles the following conversion specifiers:
...
| **Compiler** | `gcc 4.8.4` |
| **Style Guidelines** | [`Betty`](https://github.com/mainschool/Betty/blob/master/betty-style.pl "betty-style.pl") |
...
-   Your code should use the  `Betty`  style. It will be checked using  [betty-style.pl](https://github.com/mainschool/Betty/blob/master/betty-style.pl "betty-style.pl")  and  [betty-doc.pl](https://github.com/mainschool/Betty/blob/master/betty-doc.pl "betty-doc.pl")
